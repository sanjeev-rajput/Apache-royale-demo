 ...
 * @type {Object}
 */
org.apache.royale.utils.Language.interfaceMap = null;
 ...
 * @type {boolean}
 */
org.apache.royale.utils.Language.isInitInterfaceMap = false;
...
org.apache.royale.utils.Language.checkInterfaces = function(leftOperand, rightOperand) {
  ...
  for (i = (interfaces.length - 1) >> 0; i > -1; i--) {
    var /** @type {*} */ theInterface = interfaces[i];
    ...
    if (theInterface.prototype.ROYALE_CLASS_INFO && theInterface.prototype.ROYALE_CLASS_INFO.interfaces) {
      var /** @type {boolean} */ isit = org.apache.royale.utils.Language.checkInterfaces(theInterface.prototype, rightOperand);
      if (isit)
        return true;
    }
  }
