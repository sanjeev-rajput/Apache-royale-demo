 ...
 * @override
 */
com.unhurdle.spectrum.renderers.DataItemRenderer.prototype.requiresView = function() {
  return false;
};
...
com.unhurdle.spectrum.renderers.DataItemRenderer.prototype.set__data = function(value) {
  ...
  if (!hasData || (org.apache.royale.utils.getSelectionRenderBead(this) && !org.apache.royale.utils.getSelectionRenderBead(this).selected)) {
