...
!(function (t, e) {
    ...
    function Li(t) {
        return "angle" === t ? { between: J, compare: K, normalize: G } : { between: tt, compare: (t, e) => t - e, normalize: (t) => t };
    }
    ...
    function Ri(t, e, i) {
        ...
        for (let t = c, i = c; t <= d; ++t)
            (m = e[t % a]),
                m.skip || ((p = h(m[s])), p !== x && ((b = l(p, n, o)), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ei({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)), (i = t), (x = p)));
            ...
            const n = ki(t.options.layout.padding),
                ...
                r = (function (t) {
                    const e = (function (t) {
                        ...
                        r = Zi(e, "x"),
                        l = Zi(e, "y");
                    return { fullSize: i, leftAndTop: s.concat(o), rightAndBottom: n.concat(l).concat(a).concat(r), chartArea: Ji(e, "chartArea"), vertical: s.concat(n).concat(l), horizontal: o.concat(a).concat(r) };
                })(t.boxes),
                l = r.vertical,
                h = r.horizontal;
            u(t.boxes, (t) => {
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t
                ? ((function (t, e) {
                      ...
                      if (((t[ds] = { initial: { height: s, width: n, style: { display: i.display, height: i.height, width: i.width } } }), (i.display = i.display || "block"), (i.boxSizing = i.boxSizing || "border-box"), fs(n))) {
                          const e = Pe(t, "width");
                          void 0 !== e && (t.width = e);
                      }
                      if (fs(s))
    ...
    class tn extends $s {
        ...
        update(t, e, i) {
            ...
            this._convertTicksToLabels(r ? Ks(this.ticks, a) : this.ticks),
                ...
                o.display && (o.autoSkip || "auto" === o.source) && ((this.ticks = Ys(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
        ...
        _computeLabelSizes(t, e, i) {
            ...
            let c,
                ...
                w = 0;
            for (c = 0; c < e; c += h) {
                if (((g = t[c].label), (p = this._resolveTickFontOptions(c)), (o.font = m = p.string), (x = a[m] = a[m] || { data: {}, gc: [] }), (b = p.lineHeight), (_ = y = 0), s(g) || n(g))) {
        ...
        _computeLabelItems(t) {
            ...
            for (b = 0, _ = l.length; b < _; ++b) {
                ...
                x.push({ label: v, font: P, textOffset: O, options: { rotation: m, color: i, strokeColor: o, strokeWidth: h, textAlign: f, textBaseline: A, translation: [M, w], backdrop: d } });
            }
            return x;
        }
    ...
    class Tn {
        ...
        constructor(t, e) {
            ...
            (this.id = i()),
                ...
                (this._dataChanges = []),
                (Cn[this.id] = this),
                r && l ? (bt.listen(this, "complete", Sn), bt.listen(this, "progress", Pn), this._initialize(), this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item");
        }
        get aspectRatio() {
            const {
    ...
    var Un = Object.freeze({
        ...
        BarController: class extends js {
            ...
            _getRuler() {
                ...
                return { min: a || zn(e), pixels: s, start: i._startPixel, end: i._endPixel, stackCount: this._getStackCount(), scale: i, grouped: t.grouped, ratio: a ? 1 : t.categoryPercentage * t.barPercentage };
            }
    ...
    function ko(t, { min: e, max: i }) {
        ...
        for (; f < i; ) s.push({ value: f, major: Mo(f), significand: u }), u >= 10 ? (u = u < 15 ? 15 : 20) : u++, u >= 20 && (o++, (u = 2), (a = o >= 0 ? 1 : a)), (f = Math.round((h + d + u * Math.pow(10, o)) * a) / a);
        const g = r(t.max, f);
                        ...
                        if (0 !== e || (0 === e && this.min < 0)) {
                            ...
                            !(function (t, e, i, s, n) {
                                ...
                                (!a && !s) ||
                                    ...
                                    !l ||
                                    i < 0 ||
                                    (o.save(), (o.strokeStyle = r), (o.lineWidth = l), o.setLineDash(n.dash || []), (o.lineDashOffset = n.dashOffset), o.beginPath(), Eo(t, i, a, s), o.closePath(), o.stroke(), o.restore());
                            })(this, a, r, o, l);
                        }
                    }),
                i.display)
                        ...
                        f = (function (t, e, i, s, n) {
                            ...
                            for (a[l++] = t[p], c = 0; c < o - 2; c++) {
                                ...
                                const b = Math.floor(c * r) + 1 + e,
                                    ...
                                    { x: y, y: v } = t[p];
                                for (u = f = -1, s = b; s < _; s++) (f = 0.5 * Math.abs((y - n) * (t[s].y - v) - (y - t[s].x) * (o - v))), f > u && ((u = f), (d = t[s]), (g = s));
                                (a[l++] = d), (p = g);
                            }
                            return (a[l++] = t[h]), a;
                        })(h, d, u, n, i);
    ...
    function ua(t, e, i) {
        ...
        s &&
            ...
            (function (t, e) {
                ...
                o !== n &&
                    ("x" === h
                        ? (fa(t, s, a.top), pa(t, { line: i, target: s, color: n, scale: r, property: h, clip: l }), t.restore(), t.save(), fa(t, s, a.bottom))
                        : "y" === h && (ga(t, s, a.left), pa(t, { line: i, target: s, color: o, scale: r, property: h, clip: l }), t.restore(), t.save(), ga(t, s, a.right), (c = n)));
    ...
    function ma(t, e, i, s) {
        ...
        if ("x" === o || "y" === o) {
            let e, s, l, h;
            "x" === o ? ((e = a), (s = n.top), (l = r), (h = n.bottom)) : ((e = n.left), (s = a), (l = n.right), (h = r)),
                t.beginPath(),
                i && ((e = Math.max(e, i.left)), (l = Math.min(l, i.right)), (s = Math.max(s, i.top)), (h = Math.min(h, i.bottom))),
                t.rect(e, s, l - e, h - s),
                t.clip();
        }
    }
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                (o = t.getDatasetMeta(a)),
                    (r = o.dataset),
                    (l = null),
                    r && r.options && r instanceof oo && (l = { visible: t.isDatasetVisible(a), index: a, fill: ra(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }),
                    (o.$filler = l),
                    n.push(l);
    ...
    class ya extends $s {
        ...
        _draw() {
            ...
            (f = x ? { x: ft(n, this.left + c, this.right - i[0]), y: this.top + c + b, line: 0 } : { x: this.left + c, y: ft(n, this.top + b + c, this.bottom - e[0].height), line: 0 }), Ai(this.ctx, t.textDirection);
            const _ = m + c;
            this.legendItems.forEach((y, v) => {
                ...
                r.setWidth(this.width),
                    x
                        ...
                        : v > 0 && P + _ > this.bottom && ((S = f.x = S + e[f.line].width + c), f.line++, (P = f.y = ft(n, this.top + b + c, this.bottom - e[f.line].height)));
                if (
                    ((function (t, e, i) {
    ...
    class Wa extends $s {
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Ia(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = Si(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r)
        ...
        drawBody(t, e, i) {
            ...
            for (
                ...
                for (x = s[y], b = this.labelTextColors[y], e.fillStyle = b, u(x.before, p), _ = x.lines, a && _.length && (this._drawColorBox(e, t, y, g, i), (d = Math.max(c.lineHeight, r))), v = 0, w = _.length; v < w; ++v)
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Ia(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = Si(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a)
